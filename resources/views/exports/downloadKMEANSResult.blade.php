...
<body>
    ...
    <h3>Laporan Hasil Clustering Karyawan - {{ $tahun }}</h3>


    <!-- Tabel Skor Akhir -->
    <div class="section">
        <div class="section-title">Total Skor Akhir Simple Multi Attribute Rating Technique</div>
        <table>
            <thead>
                <tr>
                    <th>Nama</th>
            ...
            <tbody>
                @foreach ($finalScoreTotal as $item)
                    <tr>
                        <td>{{ $item->fullname }}</td>
                        <td>{{ $item->departement }}</td>
                        <td>{{ $item->employeementStatus }}</td>
                        <td>{{ number_format($item->final_score_total, 2) }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <!-- Tabel Centroid -->
    {{-- <div class="section">
        <div class="section-title">Centroid Pertama</div>
        <table>
            <thead>
                <tr>
                    <th>Tahun</th>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tbody>
                ...
                @else
                    <tr>
                        <td colspan="3" class="text-center">Belum ada hasil clustering untuk tahun ini.</td>
                    </tr>
                @endif
            </tbody>
        </table>
